<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CitassS.aspx.cs" Inherits="UI.CitassS" %>
...
<div class="navbar navbar-inverse navbar-fixed-top" >
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" style="color:white" runat="server" href="~/IndexSecretaria.aspx">Logo</a>
                </div>
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        
                        
                        <li><a runat="server" style="color:white" href="~/CitassS.aspx">Pacientes</a></li>
                        <li><a runat="server" style="color:white" href="~/DiagnosticoS.aspx">Diagnosticos</a></li>
                        <li><a runat="server" style="color:white" href="~/IndexCitasS.aspx">Citas</a></li>
                    </ul>
