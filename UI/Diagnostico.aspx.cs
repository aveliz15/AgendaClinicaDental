            ...
            try
            {
                ...
                if (d27.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 27);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d28.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 28);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d29.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 29);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d30.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 30);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d26.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 26);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d31.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 31);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d25.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 25);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d32.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 32);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d24.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 24);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d33.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 33);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d23.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 23);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d34.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 34);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d22.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 22);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d35.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 35);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d21.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 21);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d36.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 36);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d52.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 52);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d37.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 37);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d51.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 51);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d38.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 38);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d50.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 50);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d39.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 39);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d49.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 49);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d40.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 40);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d48.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 48);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d41.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 41);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d47.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 47);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d42.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 42);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d46.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 46);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d45.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 45);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d44.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 44);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
            ...
            try
            {
                ...
                if (d43.BackColor == Color.Red)
                {
                    ...
                    if (MostrarDiagnostico.Visible == true)
                    {
                        ...
                        mensajeError.Visible = false;
                        QuitarMensajes();
                        ListaDiagnosticos = diag.ListarDiagnostico(Diagnostico.id, 43);
                        LVDiagnosticos.DataSource = ListaDiagnosticos.ToList();
                        LVDiagnosticos.DataBind();
                        MostrarDiagnostico.Visible = true;
                    }
