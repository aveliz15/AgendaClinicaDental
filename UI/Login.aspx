<%@ Page Title="" Language="C#" MasterPageFile="~/Login.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="UI_ClinicaDental.Login" %>
...
<%--  --%>
    ...
    <asp:HyperLink ID="Link1" runat="server" NavigateUrl="~/RecuperarPassword.aspx" Text="Recuperar Contraseña" />
