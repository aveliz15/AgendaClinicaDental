<%@ Page Title="Registrar un inicio de sesión externo" Language="C#" MasterPageFile="~/Dentista.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="UI_ClinicaDental.Account.RegisterExternalLogin" Async="true" %>
